...
public class DownPesquisaBoleias extends AsyncTask<Void, Void, String> {
  ...
  //  public BoleiasPesquisaListaFragment ma;
    ...
    //http://soft.allprint.pt/index.php/getjson/PesquisaBoleiasLocais/2/3
    private static String url = "http://soft.allprint.pt/index.php/getjson/PesquisaBoleiasLocais/";
   // private static String urlData = "http://soft.allprint.pt/index.php/getjson/PesquisaBoleiasLocaisData/";
