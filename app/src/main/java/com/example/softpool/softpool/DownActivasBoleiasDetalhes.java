...
public class DownActivasBoleiasDetalhes extends AsyncTask<Void, Void, Void> {
  ...
  //  public BoleiasPesquisaListaFragment ma;
    ...
    private static String url = "http://soft.allprint.pt/index.php/getjson/getBoleiaByid/";
    private static String urlpassageiro = "http://soft.allprint.pt/index.php/getjson/getPassageirosBoleia/";
            ...
            try {
                ...
                for (int i = 0; i < boleiasUser.length(); i++) {
                    ...
                    if (imgUser.compareTo("")!=0) {
                        try {
                            URL url = utils.stringToURL("http://soft.allprint.pt/assets/fotos/" + imgUser);
